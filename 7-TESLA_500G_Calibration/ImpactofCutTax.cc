...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////	
	...
	hist_TaxPyth_al_912->SetLineColor(kBlack); hist_TaxPyth_al_912->SetMarkerColor(kBlack); hist_TaxPyth_al_912->SetMarkerStyle(3); hist_TaxPyth_al_912->SetLineWidth(1); hist_TaxPyth_al_912->SetMarkerSize(1);
	TH1F* hist_TaxPyth_Zq_912 = (TH1F*)input_912->Get("hist_TaxPyth_Zq");
	hist_TaxPyth_Zq_912->SetLineColor(kRed+2); hist_TaxPyth_Zq_912->SetMarkerColor(kRed+2); hist_TaxPyth_Zq_912->SetMarkerStyle(20); hist_TaxPyth_Zq_912->SetLineWidth(1); hist_TaxPyth_Zq_912->SetMarkerSize(1);
	TH1F* hist_TaxPyth_WW_912 = (TH1F*)input_912->Get("hist_TaxPyth_WW");
	hist_TaxPyth_WW_912->SetLineColor(kGreen+2); hist_TaxPyth_WW_912->SetMarkerColor(kGreen+2); hist_TaxPyth_WW_912->SetMarkerStyle(21); hist_TaxPyth_WW_912->SetLineWidth(1); hist_TaxPyth_WW_912->SetMarkerSize(1);
	TH1F* hist_TaxPyth_ZZ_912 = (TH1F*)input_912->Get("hist_TaxPyth_ZZ");
	hist_TaxPyth_ZZ_912->SetLineColor(kBlue+2); hist_TaxPyth_ZZ_912->SetMarkerColor(kBlue+2); hist_TaxPyth_ZZ_912->SetMarkerStyle(22); hist_TaxPyth_ZZ_912->SetLineWidth(1); hist_TaxPyth_ZZ_912->SetMarkerSize(1);
	TH1F* hist_TaxPyth_tt_912 = (TH1F*)input_912->Get("hist_TaxPyth_tt");
	hist_TaxPyth_tt_912->SetLineColor(kYellow+2); hist_TaxPyth_tt_912->SetMarkerColor(kYellow+2); hist_TaxPyth_tt_912->SetMarkerStyle(23); hist_TaxPyth_tt_912->SetLineWidth(1); hist_TaxPyth_tt_912->SetMarkerSize(1);
	TH1F* hist_TaxPyth_HZ_912 = (TH1F*)input_912->Get("hist_TaxPyth_HZ");
	hist_TaxPyth_HZ_912->SetLineColor(kMagenta+2); hist_TaxPyth_HZ_912->SetMarkerColor(kMagenta+2); hist_TaxPyth_HZ_912->SetMarkerStyle(33); hist_TaxPyth_HZ_912->SetLineWidth(1); hist_TaxPyth_HZ_912->SetMarkerSize(1);
	TH1F* hist_TaxPyth_HW_912 = (TH1F*)input_912->Get("hist_TaxPyth_HW");
	hist_TaxPyth_HW_912->SetLineColor(kCyan+2); hist_TaxPyth_HW_912->SetMarkerColor(kCyan+2); hist_TaxPyth_HW_912->SetMarkerStyle(47); hist_TaxPyth_HW_912->SetLineWidth(1); hist_TaxPyth_HW_912->SetMarkerSize(1);

	TH1F* hist_TaxPyth_al_160 = (TH1F*)input_160->Get("hist_TaxPyth");
	hist_TaxPyth_al_160->SetLineColor(kBlack); hist_TaxPyth_al_160->SetMarkerColor(kBlack); hist_TaxPyth_al_160->SetMarkerStyle(3); hist_TaxPyth_al_160->SetLineWidth(1); hist_TaxPyth_al_160->SetMarkerSize(1);
	TH1F* hist_TaxPyth_Zq_160 = (TH1F*)input_160->Get("hist_TaxPyth_Zq");
	hist_TaxPyth_Zq_160->SetLineColor(kRed+2); hist_TaxPyth_Zq_160->SetMarkerColor(kRed+2); hist_TaxPyth_Zq_160->SetMarkerStyle(20); hist_TaxPyth_Zq_160->SetLineWidth(1); hist_TaxPyth_Zq_160->SetMarkerSize(1);
	TH1F* hist_TaxPyth_WW_160 = (TH1F*)input_160->Get("hist_TaxPyth_WW");
	hist_TaxPyth_WW_160->SetLineColor(kGreen+2); hist_TaxPyth_WW_160->SetMarkerColor(kGreen+2); hist_TaxPyth_WW_160->SetMarkerStyle(21); hist_TaxPyth_WW_160->SetLineWidth(1); hist_TaxPyth_WW_160->SetMarkerSize(1);
	TH1F* hist_TaxPyth_ZZ_160 = (TH1F*)input_160->Get("hist_TaxPyth_ZZ");
	hist_TaxPyth_ZZ_160->SetLineColor(kBlue+2); hist_TaxPyth_ZZ_160->SetMarkerColor(kBlue+2); hist_TaxPyth_ZZ_160->SetMarkerStyle(22); hist_TaxPyth_ZZ_160->SetLineWidth(1); hist_TaxPyth_ZZ_160->SetMarkerSize(1);
	TH1F* hist_TaxPyth_tt_160 = (TH1F*)input_160->Get("hist_TaxPyth_tt");
	hist_TaxPyth_tt_160->SetLineColor(kYellow+2); hist_TaxPyth_tt_160->SetMarkerColor(kYellow+2); hist_TaxPyth_tt_160->SetMarkerStyle(23); hist_TaxPyth_tt_160->SetLineWidth(1); hist_TaxPyth_tt_160->SetMarkerSize(1);
	TH1F* hist_TaxPyth_HZ_160 = (TH1F*)input_160->Get("hist_TaxPyth_HZ");
	hist_TaxPyth_HZ_160->SetLineColor(kMagenta+2); hist_TaxPyth_HZ_160->SetMarkerColor(kMagenta+2); hist_TaxPyth_HZ_160->SetMarkerStyle(33); hist_TaxPyth_HZ_160->SetLineWidth(1); hist_TaxPyth_HZ_160->SetMarkerSize(1);
	TH1F* hist_TaxPyth_HW_160 = (TH1F*)input_160->Get("hist_TaxPyth_HW");
	hist_TaxPyth_HW_160->SetLineColor(kCyan+2); hist_TaxPyth_HW_160->SetMarkerColor(kCyan+2); hist_TaxPyth_HW_160->SetMarkerStyle(47); hist_TaxPyth_HW_160->SetLineWidth(1); hist_TaxPyth_HW_160->SetMarkerSize(1);

	TH1F* hist_TaxPyth_al_240 = (TH1F*)input_240->Get("hist_TaxPyth");
	hist_TaxPyth_al_240->SetLineColor(kBlack); hist_TaxPyth_al_240->SetMarkerColor(kBlack); hist_TaxPyth_al_240->SetMarkerStyle(3); hist_TaxPyth_al_240->SetLineWidth(1); hist_TaxPyth_al_240->SetMarkerSize(1);
	TH1F* hist_TaxPyth_Zq_240 = (TH1F*)input_240->Get("hist_TaxPyth_Zq");
	hist_TaxPyth_Zq_240->SetLineColor(kRed+2); hist_TaxPyth_Zq_240->SetMarkerColor(kRed+2); hist_TaxPyth_Zq_240->SetMarkerStyle(20); hist_TaxPyth_Zq_240->SetLineWidth(1); hist_TaxPyth_Zq_240->SetMarkerSize(1);
	TH1F* hist_TaxPyth_WW_240 = (TH1F*)input_240->Get("hist_TaxPyth_WW");
	hist_TaxPyth_WW_240->SetLineColor(kGreen+2); hist_TaxPyth_WW_240->SetMarkerColor(kGreen+2); hist_TaxPyth_WW_240->SetMarkerStyle(21); hist_TaxPyth_WW_240->SetLineWidth(1); hist_TaxPyth_WW_240->SetMarkerSize(1);
	TH1F* hist_TaxPyth_ZZ_240 = (TH1F*)input_240->Get("hist_TaxPyth_ZZ");
	hist_TaxPyth_ZZ_240->SetLineColor(kBlue+2); hist_TaxPyth_ZZ_240->SetMarkerColor(kBlue+2); hist_TaxPyth_ZZ_240->SetMarkerStyle(22); hist_TaxPyth_ZZ_240->SetLineWidth(1); hist_TaxPyth_ZZ_240->SetMarkerSize(1);
	TH1F* hist_TaxPyth_tt_240 = (TH1F*)input_240->Get("hist_TaxPyth_tt");
	hist_TaxPyth_tt_240->SetLineColor(kYellow+2); hist_TaxPyth_tt_240->SetMarkerColor(kYellow+2); hist_TaxPyth_tt_240->SetMarkerStyle(23); hist_TaxPyth_tt_240->SetLineWidth(1); hist_TaxPyth_tt_240->SetMarkerSize(1);
	TH1F* hist_TaxPyth_HZ_240 = (TH1F*)input_240->Get("hist_TaxPyth_HZ");
	hist_TaxPyth_HZ_240->SetLineColor(kMagenta+2); hist_TaxPyth_HZ_240->SetMarkerColor(kMagenta+2); hist_TaxPyth_HZ_240->SetMarkerStyle(33); hist_TaxPyth_HZ_240->SetLineWidth(1); hist_TaxPyth_HZ_240->SetMarkerSize(1);
	TH1F* hist_TaxPyth_HW_240 = (TH1F*)input_240->Get("hist_TaxPyth_HW");
	hist_TaxPyth_HW_240->SetLineColor(kCyan+2); hist_TaxPyth_HW_240->SetMarkerColor(kCyan+2); hist_TaxPyth_HW_240->SetMarkerStyle(47); hist_TaxPyth_HW_240->SetLineWidth(1); hist_TaxPyth_HW_240->SetMarkerSize(1);

	TH1F* hist_TaxPyth_al_365 = (TH1F*)input_365->Get("hist_TaxPyth");
	hist_TaxPyth_al_365->SetLineColor(kBlack); hist_TaxPyth_al_365->SetMarkerColor(kBlack); hist_TaxPyth_al_365->SetMarkerStyle(3); hist_TaxPyth_al_365->SetLineWidth(1); hist_TaxPyth_al_365->SetMarkerSize(1);
	TH1F* hist_TaxPyth_Zq_365 = (TH1F*)input_365->Get("hist_TaxPyth_Zq");
	hist_TaxPyth_Zq_365->SetLineColor(kRed+2); hist_TaxPyth_Zq_365->SetMarkerColor(kRed+2); hist_TaxPyth_Zq_365->SetMarkerStyle(20); hist_TaxPyth_Zq_365->SetLineWidth(1); hist_TaxPyth_Zq_365->SetMarkerSize(1);
	TH1F* hist_TaxPyth_WW_365 = (TH1F*)input_365->Get("hist_TaxPyth_WW");
	hist_TaxPyth_WW_365->SetLineColor(kGreen+2); hist_TaxPyth_WW_365->SetMarkerColor(kGreen+2); hist_TaxPyth_WW_365->SetMarkerStyle(21); hist_TaxPyth_WW_365->SetLineWidth(1); hist_TaxPyth_WW_365->SetMarkerSize(1);
	TH1F* hist_TaxPyth_ZZ_365 = (TH1F*)input_365->Get("hist_TaxPyth_ZZ");
	hist_TaxPyth_ZZ_365->SetLineColor(kBlue+2); hist_TaxPyth_ZZ_365->SetMarkerColor(kBlue+2); hist_TaxPyth_ZZ_365->SetMarkerStyle(22); hist_TaxPyth_ZZ_365->SetLineWidth(1); hist_TaxPyth_ZZ_365->SetMarkerSize(1);
	TH1F* hist_TaxPyth_tt_365 = (TH1F*)input_365->Get("hist_TaxPyth_tt");
	hist_TaxPyth_tt_365->SetLineColor(kYellow+2); hist_TaxPyth_tt_365->SetMarkerColor(kYellow+2); hist_TaxPyth_tt_365->SetMarkerStyle(23); hist_TaxPyth_tt_365->SetLineWidth(1); hist_TaxPyth_tt_365->SetMarkerSize(1);
	TH1F* hist_TaxPyth_HZ_365 = (TH1F*)input_365->Get("hist_TaxPyth_HZ");
	hist_TaxPyth_HZ_365->SetLineColor(kMagenta+2); hist_TaxPyth_HZ_365->SetMarkerColor(kMagenta+2); hist_TaxPyth_HZ_365->SetMarkerStyle(33); hist_TaxPyth_HZ_365->SetLineWidth(1); hist_TaxPyth_HZ_365->SetMarkerSize(1);
	TH1F* hist_TaxPyth_HW_365 = (TH1F*)input_365->Get("hist_TaxPyth_HW");
	hist_TaxPyth_HW_365->SetLineColor(kCyan+2); hist_TaxPyth_HW_365->SetMarkerColor(kCyan+2); hist_TaxPyth_HW_365->SetMarkerStyle(47); hist_TaxPyth_HW_365->SetLineWidth(1); hist_TaxPyth_HW_365->SetMarkerSize(1);
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	// Create canvas
	TCanvas* cv5 = new TCanvas("cv5", "FCC-ee ISR Studies", 800, 2090);
	...
	hist_TaxPyth_al_912->Draw("HIST SAME");
	lg5->Draw("SAME");

...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	// Create canvas
	TCanvas* cv2 = new TCanvas("cv2", "FCC-ee ISR Studies", 1400, 850);

	// Add legend
	TLegend* lg2 = new TLegend(0.73, 0.70, 0.92, 0.95);
	...
	lg2->AddEntry(hist_ThrPyth_HW_365, "ee#rightarrow#nu_{e}#bar{#nu_{e}}H", "L");

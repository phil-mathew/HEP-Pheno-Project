...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	hist_TaxPyth_al_912_woCut->SetLineColor(kBlack); hist_TaxPyth_al_912_woCut->SetMarkerColor(kBlack); hist_TaxPyth_al_912_woCut->SetMarkerStyle(3); hist_TaxPyth_al_912_woCut->SetLineWidth(3); hist_TaxPyth_al_912_woCut->SetMarkerSize(1);
	TH1F* hist_TaxPyth_Zq_912_woCut = (TH1F*)input_912_woCut->Get("hist_TaxPyth_Zq");
	hist_TaxPyth_Zq_912_woCut->SetLineColor(kRed+2); hist_TaxPyth_Zq_912_woCut->SetMarkerColor(kRed+2); hist_TaxPyth_Zq_912_woCut->SetMarkerStyle(3); hist_TaxPyth_Zq_912_woCut->SetLineWidth(3); hist_TaxPyth_Zq_912_woCut->SetMarkerSize(1);
	TH1F* hist_TaxPyth_WW_912_woCut = (TH1F*)input_912_woCut->Get("hist_TaxPyth_WW");
	hist_TaxPyth_WW_912_woCut->SetLineColor(kGreen+2); hist_TaxPyth_WW_912_woCut->SetMarkerColor(kGreen+2); hist_TaxPyth_WW_912_woCut->SetMarkerStyle(3); hist_TaxPyth_WW_912_woCut->SetLineWidth(3); hist_TaxPyth_WW_912_woCut->SetMarkerSize(1);
	TH1F* hist_TaxPyth_ZZ_912_woCut = (TH1F*)input_912_woCut->Get("hist_TaxPyth_ZZ");
	hist_TaxPyth_ZZ_912_woCut->SetLineColor(kBlue+2); hist_TaxPyth_ZZ_912_woCut->SetMarkerColor(kBlue+2); hist_TaxPyth_ZZ_912_woCut->SetMarkerStyle(3); hist_TaxPyth_ZZ_912_woCut->SetLineWidth(3); hist_TaxPyth_ZZ_912_woCut->SetMarkerSize(1);
	TH1F* hist_TaxPyth_tt_912_woCut = (TH1F*)input_912_woCut->Get("hist_TaxPyth_tt");
	hist_TaxPyth_tt_912_woCut->SetLineColor(kYellow+2); hist_TaxPyth_tt_912_woCut->SetMarkerColor(kYellow+2); hist_TaxPyth_tt_912_woCut->SetMarkerStyle(3); hist_TaxPyth_tt_912_woCut->SetLineWidth(3); hist_TaxPyth_tt_912_woCut->SetMarkerSize(1);
	TH1F* hist_TaxPyth_HZ_912_woCut = (TH1F*)input_912_woCut->Get("hist_TaxPyth_HZ");
	hist_TaxPyth_HZ_912_woCut->SetLineColor(kMagenta+2); hist_TaxPyth_HZ_912_woCut->SetMarkerColor(kMagenta+2); hist_TaxPyth_HZ_912_woCut->SetMarkerStyle(53); hist_TaxPyth_HZ_912_woCut->SetLineWidth(3); hist_TaxPyth_HZ_912_woCut->SetMarkerSize(1);
	TH1F* hist_TaxPyth_HW_912_woCut = (TH1F*)input_912_woCut->Get("hist_TaxPyth_HW");
	hist_TaxPyth_HW_912_woCut->SetLineColor(kCyan+2); hist_TaxPyth_HW_912_woCut->SetMarkerColor(kCyan+2); hist_TaxPyth_HW_912_woCut->SetMarkerStyle(53); hist_TaxPyth_HW_912_woCut->SetLineWidth(3); hist_TaxPyth_HW_912_woCut->SetMarkerSize(1);

	TH1F* hist_TaxPyth_al_160_woCut = (TH1F*)input_160_woCut->Get("hist_TaxPyth");
	hist_TaxPyth_al_160_woCut->SetLineColor(kBlack); hist_TaxPyth_al_160_woCut->SetMarkerColor(kBlack); hist_TaxPyth_al_160_woCut->SetMarkerStyle(3); hist_TaxPyth_al_160_woCut->SetLineWidth(3); hist_TaxPyth_al_160_woCut->SetMarkerSize(1);
	TH1F* hist_TaxPyth_Zq_160_woCut = (TH1F*)input_160_woCut->Get("hist_TaxPyth_Zq");
	hist_TaxPyth_Zq_160_woCut->SetLineColor(kRed+2); hist_TaxPyth_Zq_160_woCut->SetMarkerColor(kRed+2); hist_TaxPyth_Zq_160_woCut->SetMarkerStyle(3); hist_TaxPyth_Zq_160_woCut->SetLineWidth(3); hist_TaxPyth_Zq_160_woCut->SetMarkerSize(1);
	TH1F* hist_TaxPyth_WW_160_woCut = (TH1F*)input_160_woCut->Get("hist_TaxPyth_WW");
	hist_TaxPyth_WW_160_woCut->SetLineColor(kGreen+2); hist_TaxPyth_WW_160_woCut->SetMarkerColor(kGreen+2); hist_TaxPyth_WW_160_woCut->SetMarkerStyle(3); hist_TaxPyth_WW_160_woCut->SetLineWidth(3); hist_TaxPyth_WW_160_woCut->SetMarkerSize(1);
	TH1F* hist_TaxPyth_ZZ_160_woCut = (TH1F*)input_160_woCut->Get("hist_TaxPyth_ZZ");
	hist_TaxPyth_ZZ_160_woCut->SetLineColor(kBlue+2); hist_TaxPyth_ZZ_160_woCut->SetMarkerColor(kBlue+2); hist_TaxPyth_ZZ_160_woCut->SetMarkerStyle(3); hist_TaxPyth_ZZ_160_woCut->SetLineWidth(3); hist_TaxPyth_ZZ_160_woCut->SetMarkerSize(1);
	TH1F* hist_TaxPyth_tt_160_woCut = (TH1F*)input_160_woCut->Get("hist_TaxPyth_tt");
	hist_TaxPyth_tt_160_woCut->SetLineColor(kYellow+2); hist_TaxPyth_tt_160_woCut->SetMarkerColor(kYellow+2); hist_TaxPyth_tt_160_woCut->SetMarkerStyle(3); hist_TaxPyth_tt_160_woCut->SetLineWidth(3); hist_TaxPyth_tt_160_woCut->SetMarkerSize(1);
	TH1F* hist_TaxPyth_HZ_160_woCut = (TH1F*)input_160_woCut->Get("hist_TaxPyth_HZ");
	hist_TaxPyth_HZ_160_woCut->SetLineColor(kMagenta+2); hist_TaxPyth_HZ_160_woCut->SetMarkerColor(kMagenta+2); hist_TaxPyth_HZ_160_woCut->SetMarkerStyle(53); hist_TaxPyth_HZ_160_woCut->SetLineWidth(3); hist_TaxPyth_HZ_160_woCut->SetMarkerSize(1);
	TH1F* hist_TaxPyth_HW_160_woCut = (TH1F*)input_160_woCut->Get("hist_TaxPyth_HW");
	hist_TaxPyth_HW_160_woCut->SetLineColor(kCyan+2); hist_TaxPyth_HW_160_woCut->SetMarkerColor(kCyan+2); hist_TaxPyth_HW_160_woCut->SetMarkerStyle(53); hist_TaxPyth_HW_160_woCut->SetLineWidth(3); hist_TaxPyth_HW_160_woCut->SetMarkerSize(1);

	TH1F* hist_TaxPyth_al_240_woCut = (TH1F*)input_240_woCut->Get("hist_TaxPyth");
	hist_TaxPyth_al_240_woCut->SetLineColor(kBlack); hist_TaxPyth_al_240_woCut->SetMarkerColor(kBlack); hist_TaxPyth_al_240_woCut->SetMarkerStyle(3); hist_TaxPyth_al_240_woCut->SetLineWidth(3); hist_TaxPyth_al_240_woCut->SetMarkerSize(1);
	TH1F* hist_TaxPyth_Zq_240_woCut = (TH1F*)input_240_woCut->Get("hist_TaxPyth_Zq");
	hist_TaxPyth_Zq_240_woCut->SetLineColor(kRed+2); hist_TaxPyth_Zq_240_woCut->SetMarkerColor(kRed+2); hist_TaxPyth_Zq_240_woCut->SetMarkerStyle(3); hist_TaxPyth_Zq_240_woCut->SetLineWidth(3); hist_TaxPyth_Zq_240_woCut->SetMarkerSize(1);
	TH1F* hist_TaxPyth_WW_240_woCut = (TH1F*)input_240_woCut->Get("hist_TaxPyth_WW");
	hist_TaxPyth_WW_240_woCut->SetLineColor(kGreen+2); hist_TaxPyth_WW_240_woCut->SetMarkerColor(kGreen+2); hist_TaxPyth_WW_240_woCut->SetMarkerStyle(3); hist_TaxPyth_WW_240_woCut->SetLineWidth(3); hist_TaxPyth_WW_240_woCut->SetMarkerSize(1);
	TH1F* hist_TaxPyth_ZZ_240_woCut = (TH1F*)input_240_woCut->Get("hist_TaxPyth_ZZ");
	hist_TaxPyth_ZZ_240_woCut->SetLineColor(kBlue+2); hist_TaxPyth_ZZ_240_woCut->SetMarkerColor(kBlue+2); hist_TaxPyth_ZZ_240_woCut->SetMarkerStyle(3); hist_TaxPyth_ZZ_240_woCut->SetLineWidth(3); hist_TaxPyth_ZZ_240_woCut->SetMarkerSize(1);
	TH1F* hist_TaxPyth_tt_240_woCut = (TH1F*)input_240_woCut->Get("hist_TaxPyth_tt");
	hist_TaxPyth_tt_240_woCut->SetLineColor(kYellow+2); hist_TaxPyth_tt_240_woCut->SetMarkerColor(kYellow+2); hist_TaxPyth_tt_240_woCut->SetMarkerStyle(3); hist_TaxPyth_tt_240_woCut->SetLineWidth(3); hist_TaxPyth_tt_240_woCut->SetMarkerSize(1);
	TH1F* hist_TaxPyth_HZ_240_woCut = (TH1F*)input_240_woCut->Get("hist_TaxPyth_HZ");
	hist_TaxPyth_HZ_240_woCut->SetLineColor(kMagenta+2); hist_TaxPyth_HZ_240_woCut->SetMarkerColor(kMagenta+2); hist_TaxPyth_HZ_240_woCut->SetMarkerStyle(53); hist_TaxPyth_HZ_240_woCut->SetLineWidth(3); hist_TaxPyth_HZ_240_woCut->SetMarkerSize(1);
	TH1F* hist_TaxPyth_HW_240_woCut = (TH1F*)input_240_woCut->Get("hist_TaxPyth_HW");
	hist_TaxPyth_HW_240_woCut->SetLineColor(kCyan+2); hist_TaxPyth_HW_240_woCut->SetMarkerColor(kCyan+2); hist_TaxPyth_HW_240_woCut->SetMarkerStyle(53); hist_TaxPyth_HW_240_woCut->SetLineWidth(3); hist_TaxPyth_HW_240_woCut->SetMarkerSize(1);

	TH1F* hist_TaxPyth_al_365_woCut = (TH1F*)input_365_woCut->Get("hist_TaxPyth");
	hist_TaxPyth_al_365_woCut->SetLineColor(kBlack); hist_TaxPyth_al_365_woCut->SetMarkerColor(kBlack); hist_TaxPyth_al_365_woCut->SetMarkerStyle(3); hist_TaxPyth_al_365_woCut->SetLineWidth(3); hist_TaxPyth_al_365_woCut->SetMarkerSize(1);
	TH1F* hist_TaxPyth_Zq_365_woCut = (TH1F*)input_365_woCut->Get("hist_TaxPyth_Zq");
	hist_TaxPyth_Zq_365_woCut->SetLineColor(kRed+2); hist_TaxPyth_Zq_365_woCut->SetMarkerColor(kRed+2); hist_TaxPyth_Zq_365_woCut->SetMarkerStyle(3); hist_TaxPyth_Zq_365_woCut->SetLineWidth(3); hist_TaxPyth_Zq_365_woCut->SetMarkerSize(1);
	TH1F* hist_TaxPyth_WW_365_woCut = (TH1F*)input_365_woCut->Get("hist_TaxPyth_WW");
	hist_TaxPyth_WW_365_woCut->SetLineColor(kGreen+2); hist_TaxPyth_WW_365_woCut->SetMarkerColor(kGreen+2); hist_TaxPyth_WW_365_woCut->SetMarkerStyle(3); hist_TaxPyth_WW_365_woCut->SetLineWidth(3); hist_TaxPyth_WW_365_woCut->SetMarkerSize(1);
	TH1F* hist_TaxPyth_ZZ_365_woCut = (TH1F*)input_365_woCut->Get("hist_TaxPyth_ZZ");
	hist_TaxPyth_ZZ_365_woCut->SetLineColor(kBlue+2); hist_TaxPyth_ZZ_365_woCut->SetMarkerColor(kBlue+2); hist_TaxPyth_ZZ_365_woCut->SetMarkerStyle(3); hist_TaxPyth_ZZ_365_woCut->SetLineWidth(3); hist_TaxPyth_ZZ_365_woCut->SetMarkerSize(1);
	TH1F* hist_TaxPyth_tt_365_woCut = (TH1F*)input_365_woCut->Get("hist_TaxPyth_tt");
	hist_TaxPyth_tt_365_woCut->SetLineColor(kYellow+2); hist_TaxPyth_tt_365_woCut->SetMarkerColor(kYellow+2); hist_TaxPyth_tt_365_woCut->SetMarkerStyle(3); hist_TaxPyth_tt_365_woCut->SetLineWidth(3); hist_TaxPyth_tt_365_woCut->SetMarkerSize(1);
	TH1F* hist_TaxPyth_HZ_365_woCut = (TH1F*)input_365_woCut->Get("hist_TaxPyth_HZ");
	hist_TaxPyth_HZ_365_woCut->SetLineColor(kMagenta+2); hist_TaxPyth_HZ_365_woCut->SetMarkerColor(kMagenta+2); hist_TaxPyth_HZ_365_woCut->SetMarkerStyle(53); hist_TaxPyth_HZ_365_woCut->SetLineWidth(3); hist_TaxPyth_HZ_365_woCut->SetMarkerSize(1);
	TH1F* hist_TaxPyth_HW_365_woCut = (TH1F*)input_365_woCut->Get("hist_TaxPyth_HW");
	hist_TaxPyth_HW_365_woCut->SetLineColor(kCyan+2); hist_TaxPyth_HW_365_woCut->SetMarkerColor(kCyan+2); hist_TaxPyth_HW_365_woCut->SetMarkerStyle(53); hist_TaxPyth_HW_365_woCut->SetLineWidth(3); hist_TaxPyth_HW_365_woCut->SetMarkerSize(1);
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	hist_TaxPyth_al_912_woCut->GetXaxis()->SetLabelSize(0.06); hist_TaxPyth_al_912_woCut->GetYaxis()->SetLabelSize(0.06); hist_TaxPyth_al_912_woCut->GetYaxis()->SetTitleSize(0.06); hist_TaxPyth_al_912_woCut->GetXaxis()->SetTitleSize(0.06);
	hist_TaxPyth_al_160_woCut->GetXaxis()->SetLabelSize(0.06); hist_TaxPyth_al_160_woCut->GetYaxis()->SetLabelSize(0.06); hist_TaxPyth_al_160_woCut->GetYaxis()->SetTitleSize(0.06); hist_TaxPyth_al_160_woCut->GetXaxis()->SetTitleSize(0.06);
	hist_TaxPyth_al_240_woCut->GetXaxis()->SetLabelSize(0.06); hist_TaxPyth_al_240_woCut->GetYaxis()->SetLabelSize(0.06); hist_TaxPyth_al_240_woCut->GetYaxis()->SetTitleSize(0.06); hist_TaxPyth_al_240_woCut->GetXaxis()->SetTitleSize(0.06);
	hist_TaxPyth_al_365_woCut->GetXaxis()->SetLabelSize(0.06); hist_TaxPyth_al_365_woCut->GetYaxis()->SetLabelSize(0.06); hist_TaxPyth_al_365_woCut->GetYaxis()->SetTitleSize(0.06); hist_TaxPyth_al_365_woCut->GetXaxis()->SetTitleSize(0.06);
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	hist_TaxPyth_al_912_woCut->GetYaxis()->SetTitle("N_{events}");
	hist_TaxPyth_al_160_woCut->GetYaxis()->SetTitle("N_{events}");
	hist_TaxPyth_al_240_woCut->GetYaxis()->SetTitle("N_{events}");
	hist_TaxPyth_al_365_woCut->GetYaxis()->SetTitle("N_{events}");

	hist_TaxPyth_al_912_woCut->GetXaxis()->CenterTitle(); hist_TaxPyth_al_912_woCut->GetYaxis()->CenterTitle();
	hist_TaxPyth_al_160_woCut->GetXaxis()->CenterTitle(); hist_TaxPyth_al_160_woCut->GetYaxis()->CenterTitle();
	hist_TaxPyth_al_240_woCut->GetXaxis()->CenterTitle(); hist_TaxPyth_al_240_woCut->GetYaxis()->CenterTitle();
	hist_TaxPyth_al_365_woCut->GetXaxis()->CenterTitle(); hist_TaxPyth_al_365_woCut->GetYaxis()->CenterTitle();

	hist_TaxPyth_al_912_woCut->Rebin(2);
	...
	hist_TaxPyth_al_160_woCut->Rebin(2);
	hist_TaxPyth_Zq_160_woCut->Rebin(2);
	hist_TaxPyth_WW_160_woCut->Rebin(2);
	hist_TaxPyth_ZZ_160_woCut->Rebin(2);
	...
	hist_TaxPyth_al_240_woCut->Rebin(2);
	hist_TaxPyth_Zq_240_woCut->Rebin(2);
	hist_TaxPyth_WW_240_woCut->Rebin(2);
	hist_TaxPyth_ZZ_240_woCut->Rebin(2);
	hist_TaxPyth_HZ_240_woCut->Rebin(2);
	hist_TaxPyth_HW_240_woCut->Rebin(2);
	...
	hist_TaxPyth_al_365_woCut->Rebin(2);
	hist_TaxPyth_Zq_365_woCut->Rebin(2);
	hist_TaxPyth_WW_365_woCut->Rebin(2);
	hist_TaxPyth_ZZ_365_woCut->Rebin(2);
	hist_TaxPyth_tt_365_woCut->Rebin(2);
	hist_TaxPyth_HZ_365_woCut->Rebin(2);
	hist_TaxPyth_HW_365_woCut->Rebin(2);
	...
	// Set limits
	hist_TaxPyth_al_912_woCut->GetYaxis()->SetRangeUser(1E2,1E7);
	hist_TaxPyth_al_912_woCut->GetXaxis()->SetRangeUser(-1,1);
	hist_TaxPyth_al_160_woCut->GetYaxis()->SetRangeUser(1E2,1E7);
	hist_TaxPyth_al_160_woCut->GetXaxis()->SetRangeUser(-1,1);
	hist_TaxPyth_al_240_woCut->GetYaxis()->SetRangeUser(1E2,1E7);
	hist_TaxPyth_al_240_woCut->GetXaxis()->SetRangeUser(-1,1);
	hist_TaxPyth_al_365_woCut->GetYaxis()->SetRangeUser(1E2,1E7);

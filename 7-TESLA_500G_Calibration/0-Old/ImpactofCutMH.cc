...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	TFile* input_240_wiCut = new TFile("5-CutData/cut_FCC240_wiCut_MH.root", "READ");
	TFile* input_365_wiCut = new TFile("5-CutData/cut_FCC365_wiCut_MH.root", "READ");
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	hist_MH1Pyth_al_912_woCut->GetXaxis()->SetLabelSize(0.06); hist_MH1Pyth_al_912_woCut->GetYaxis()->SetLabelSize(0.06); hist_MH1Pyth_al_912_woCut->GetYaxis()->SetTitleSize(0.06); hist_MH1Pyth_al_912_woCut->GetXaxis()->SetTitleSize(0.06);
	hist_MH2Pyth_al_912_woCut->GetXaxis()->SetLabelSize(0.06); hist_MH2Pyth_al_912_woCut->GetYaxis()->SetLabelSize(0.06); hist_MH2Pyth_al_912_woCut->GetYaxis()->SetTitleSize(0.06); hist_MH2Pyth_al_912_woCut->GetXaxis()->SetTitleSize(0.06); 
	hist_MH1Pyth_al_160_woCut->GetXaxis()->SetLabelSize(0.06); hist_MH1Pyth_al_160_woCut->GetYaxis()->SetLabelSize(0.06); hist_MH1Pyth_al_160_woCut->GetYaxis()->SetTitleSize(0.06); hist_MH1Pyth_al_160_woCut->GetXaxis()->SetTitleSize(0.06);
	hist_MH2Pyth_al_160_woCut->GetXaxis()->SetLabelSize(0.06); hist_MH2Pyth_al_160_woCut->GetYaxis()->SetLabelSize(0.06); hist_MH2Pyth_al_160_woCut->GetYaxis()->SetTitleSize(0.06); hist_MH2Pyth_al_160_woCut->GetXaxis()->SetTitleSize(0.06); 
	hist_MH1Pyth_al_240_woCut->GetXaxis()->SetLabelSize(0.06); hist_MH1Pyth_al_240_woCut->GetYaxis()->SetLabelSize(0.06); hist_MH1Pyth_al_240_woCut->GetYaxis()->SetTitleSize(0.06); hist_MH1Pyth_al_240_woCut->GetXaxis()->SetTitleSize(0.06);
	hist_MH2Pyth_al_240_woCut->GetXaxis()->SetLabelSize(0.06); hist_MH2Pyth_al_240_woCut->GetYaxis()->SetLabelSize(0.06); hist_MH2Pyth_al_240_woCut->GetYaxis()->SetTitleSize(0.06); hist_MH2Pyth_al_240_woCut->GetXaxis()->SetTitleSize(0.06); 
	hist_MH1Pyth_al_365_woCut->GetXaxis()->SetLabelSize(0.06); hist_MH1Pyth_al_365_woCut->GetYaxis()->SetLabelSize(0.06); hist_MH1Pyth_al_365_woCut->GetYaxis()->SetTitleSize(0.06); hist_MH1Pyth_al_365_woCut->GetXaxis()->SetTitleSize(0.06);
	hist_MH2Pyth_al_365_woCut->GetXaxis()->SetLabelSize(0.06); hist_MH2Pyth_al_365_woCut->GetYaxis()->SetLabelSize(0.06); hist_MH2Pyth_al_365_woCut->GetYaxis()->SetTitleSize(0.06); hist_MH2Pyth_al_365_woCut->GetXaxis()->SetTitleSize(0.06); 
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	// Add legend
	TLegend* lg5 = new TLegend(0.79, 0.60, 0.92, 0.93);
	lg5->AddEntry(hist_MH2Pyth_al_365_woCut, "ee#rightarrowq#bar{q}", "L");
	lg5->AddEntry(hist_MH2Pyth_Zq_365_woCut, "ee#rightarrow#gamma/Z", "L");
	lg5->AddEntry(hist_MH2Pyth_ZZ_365_woCut, "ee#rightarrowZZ", "L");
	lg5->AddEntry(hist_MH2Pyth_WW_365_woCut, "ee#rightarrowWW", "L");
	lg5->AddEntry(hist_MH2Pyth_tt_365_woCut, "ee#rightarrowt#bar{t}", "L");
	lg5->AddEntry(hist_MH2Pyth_HZ_365_woCut, "ee#rightarrowZH", "L");
	lg5->AddEntry(hist_MH2Pyth_HW_365_woCut, "ee#rightarrow#nu#bar{#nu}H", "L");
	...
	hist_MH2Pyth_al_912_woCut->GetYaxis()->SetTitle("N_{events}");
	hist_MH2Pyth_al_160_woCut->GetYaxis()->SetTitle("N_{events}");
	hist_MH2Pyth_al_240_woCut->GetYaxis()->SetTitle("N_{events}");
	hist_MH2Pyth_al_365_woCut->GetYaxis()->SetTitle("N_{events}");

	hist_MH2Pyth_al_912_woCut->GetXaxis()->CenterTitle(); hist_MH2Pyth_al_912_woCut->GetYaxis()->CenterTitle();
	hist_MH2Pyth_al_160_woCut->GetXaxis()->CenterTitle(); hist_MH2Pyth_al_160_woCut->GetYaxis()->CenterTitle();
	hist_MH2Pyth_al_240_woCut->GetXaxis()->CenterTitle(); hist_MH2Pyth_al_240_woCut->GetYaxis()->CenterTitle();
	hist_MH2Pyth_al_365_woCut->GetXaxis()->CenterTitle(); hist_MH2Pyth_al_365_woCut->GetYaxis()->CenterTitle();

	hist_MH2Pyth_al_912_woCut->Rebin(2);
	...
	hist_MH2Pyth_al_160_woCut->Rebin(2);
	hist_MH2Pyth_Zq_160_woCut->Rebin(2);
	hist_MH2Pyth_WW_160_woCut->Rebin(2);
	hist_MH2Pyth_ZZ_160_woCut->Rebin(2);
	...
	hist_MH2Pyth_al_240_woCut->Rebin(2);
	hist_MH2Pyth_Zq_240_woCut->Rebin(2);
	hist_MH2Pyth_WW_240_woCut->Rebin(2);
	hist_MH2Pyth_ZZ_240_woCut->Rebin(2);
	hist_MH2Pyth_HZ_240_woCut->Rebin(2);
	hist_MH2Pyth_HW_240_woCut->Rebin(2);
	...
	hist_MH2Pyth_al_365_woCut->Rebin(2);
	hist_MH2Pyth_Zq_365_woCut->Rebin(2);
	hist_MH2Pyth_WW_365_woCut->Rebin(2);
	hist_MH2Pyth_ZZ_365_woCut->Rebin(2);
	hist_MH2Pyth_tt_365_woCut->Rebin(2);
	hist_MH2Pyth_HZ_365_woCut->Rebin(2);
	hist_MH2Pyth_HW_365_woCut->Rebin(2);
	...
	// Set limits
	hist_MH2Pyth_al_912_woCut->GetYaxis()->SetRangeUser(1E0,1E7);
	hist_MH2Pyth_al_912_woCut->GetXaxis()->SetRangeUser(0,300);
	hist_MH2Pyth_al_160_woCut->GetYaxis()->SetRangeUser(1E0,1E7);
	hist_MH2Pyth_al_160_woCut->GetXaxis()->SetRangeUser(0,300);
	hist_MH2Pyth_al_240_woCut->GetYaxis()->SetRangeUser(1E0,1E7);
	hist_MH2Pyth_al_240_woCut->GetXaxis()->SetRangeUser(0,300);
	hist_MH2Pyth_al_365_woCut->GetYaxis()->SetRangeUser(1E0,1E7);
	hist_MH2Pyth_al_365_woCut->GetXaxis()->SetRangeUser(0,300);
